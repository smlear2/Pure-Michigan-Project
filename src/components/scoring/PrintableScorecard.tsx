...
export default function PrintableScorecard({
  ...
  // Cell styles
  const holeCell: React.CSSProperties = { border: bd, textAlign: 'center', verticalAlign: 'middle', fontSize: '10px', padding: '1px 1px', minWidth: '34px' }
  ...
  const labelCell: React.CSSProperties = { border: bd, textAlign: 'left', verticalAlign: 'middle', fontSize: '10px', padding: '1px 6px', whiteSpace: 'nowrap', overflow: 'hidden' }
      ...
      <table style={{ borderCollapse: 'collapse', width: '100%', tableLayout: 'fixed' }}>
        ...
        <thead>
          ...
          <tr>
            ...
            <td colSpan={2} style={{ ...holeCell, fontWeight: 'bold', borderLeft: 'none', borderBottom: 'none', borderTop: 'none' }}>HOLE</td>
            {front9.map(h => (
          ...
          <tr>
            ...
            <td colSpan={2} style={{ ...holeCell, fontWeight: 'bold', borderLeft: 'none', borderBottom: 'none', borderTop: 'none' }}>{teeName}</td>
            {front9.map(h => (
          ...
          <tr>
            ...
            <td colSpan={2} style={{ ...holeCell, fontWeight: 'bold', borderLeft: 'none', borderBottom: 'none', borderTop: 'none' }}>PAR</td>
            {front9.map(h => (
